...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin_users.css">
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-content">
            <div class="left-section">
                <div class="card-user">
                    <div class="info-panel">
                        ...
                        <p class="cc" id="todayTransactionCount">😟</p>
                        <p class="bb" id="todayTransactionDate">by today</p>
                    </div>
                    <div class="info-panel">
                        <h3>total transactions</h3>
                        <p class="cc" id="monthTransactionCount">😟</p>
                        <p class="bb" id="monthTransactionDate">nothing to see here!</p>
                    </div>
                    <div class="info-panel">
                        <h3>total transactions</h3>
                        <p class="cc" id="totalTransactions">😟</p>
                        <p class="bb">across the app</p>
                    </div>
                </div>
                ...
                <div class="new-accounts-card">
                    <div class="info-panel">
                        <div class="info-top">
                            ...
                            <button onclick="filterTransactions('recent5')" class="print-btn">
                                Print Transactions
                            </button>
                        </div>
            ...
            <div class="right-section">
                ...
                <div class="card user-details">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <div class="dropdown">
                                <button class="print-btn dropdown-toggle">Print Transactions</button>
                                <div class="dropdown-menu">
                                    <div onclick="filterTransactions('recent10')">Recent 10</div>
                                    <div onclick="filterTransactions('today')">Today</div>
                                    <div onclick="filterTransactions('week')">This Week</div>
                                    <div onclick="filterTransactions('month')">This Month</div>
                                    <div onclick="filterTransactions('all')">All</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Template for transaction entry -->
                <template id="transaction-template">
                    <div class="transaction-accordion">
                        ...
                        <div class="accordion-content">
                            <form class="user-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="username-input" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Date</label>
                                    <input type="text" class="date-input" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Slot</label>
                                    <input type="email" class="slot-input" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Amount</label>
                                    <input type="text" class="amount-input" disabled>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/admin-transactions.js"></script>

...
<div class="container">
    <div class="sidebar">
        ...
        <%--   settings icon--%>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="settings-icon">
            ...
            <div class="user-table-section">
                <div class="user-details">
                    ...
                    <table class="user-table">
                        ...
                        <tr>
                            <td>Username</td>
                            <td><span id="username">samantha_doe</span></td>
                        </tr>
                        <tr>
                            <td>Name</td>
                            <td><span id="fname">Samantha</span> <span id="lname">Doe</span></td>
                        </tr>
                        <tr>
                            <td>Email</td>

    ...
    <div class="dashboard">
        ...
        <div class="dashboard-content">
            <div class="left-section">
                <div class="card-user">
                    <div class="info-panel">
                        <h3>total users</h3>
                        <p class="cc" id="todayUserCount">😟</p>
                        <p class="bb" id="todayUserDate">by today</p>
                    </div>
                    <div class="info-panel">
                        <h3>total users</h3>
                        <p class="cc" id="monthUserCount">😟</p>
                        <p class="bb" id="monthUserDate">nothing to see here!</p>
                    </div>
                    <div class="info-panel">
                        <h3>total users</h3>
                        <p class="cc" id="totalUsers">😟</p>
            ...
            <div class="right-section">
                ...
                <!-- Template for user entry -->
                <template id="user-template">
                    <div class="user-accordion">
                        <div class="accordion-header">
                            <span>
                                <img src="https://avatar.iran.liara.run/public/" alt="user-icon" class="user-pill-icon" style="width: 30px; height: 30px">
                            </span>
                        ...
                        <div class="accordion-content">
                            <form class="user-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="first-name-input" disabled>
                                </div>
                                <div class="form-group">
                                    <label>last name</label>
                                    <input type="text" class="last-name-input" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="email-input" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="button" class="ban-btn">Ban</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/admin-users.js"></script>
